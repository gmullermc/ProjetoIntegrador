...
public class mainMenu implements ActionListener{
	...
	private static void configurarJanela()
	{
		...
		cabecalho = new JLabel("Bem-Vindo(a) ao Sistema de Reclama��es da ETE Gil Rodrigues");
		...
		descProblema = new JLabel("Descri��o");
	...
	public void actionPerformed(ActionEvent e) {
		...
		System.out.println("Descri��o do Problema: " + prob);
		try {
